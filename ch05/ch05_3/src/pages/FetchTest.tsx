// 439p 썽크 액션으로 사용자 정보 변경 화면 작성하기
  ...
  return (
    <section className="mt-4">
      ...
      <div className="flex justify-center mt-4">
        ...
        <Button className="ml-4  btn-sm btn bg-accent" onClick={changeName}>
          change name
        </Button>
        <Button className="ml-4  btn-sm btn bg-success" onClick={changeEmail}>
          change email
        </Button>
        <Button
          className="ml-4  btn-sm btn bg-secondary"
