  ...
  return (
    <section className="mt-4">
      ...
      <div className="flex justify-center mt-4">
        <Button className="btn-sm btn bg-primary" onClick={getRemoteUser}>
          get remote user
        </Button>
        <Button className="btn-sm btn bg-accent" onClick={changeName}>
          change name
        </Button>
        <Button className="btn-sm btn bg-success" onClick={changeEmail}>
          change email
        </Button>
        <Button className="btn-sm btn bg-secondary" onClick={changePicture}>
          change picture
        </Button>
      </div>
      {loading && (
